...
os.system('systemctl enable GitUpdate.service')
os.system('systemctl enable SwitchProxy.service')
os.system('systemctl enable SetDNS.service')
os.system('systemctl start SwitchProxy.service')
os.system('systemctl start SetDNS.service')
